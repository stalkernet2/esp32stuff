...
// 2 пункта выше "Однако" неакутальные - можно сделать точку доступа с телефона и тогда, и интернет, и сайт esp32 будет работает, только нужно сделать статический ip, и желательно знать его
